...
> You still need to fill in: `DEEPSEEK_API_KEY` (from your model provider console) and the Runner TLS cert path (`bash scripts/generate-runner-tls.sh deploy/runner-tls`).
