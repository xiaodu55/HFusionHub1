...
> 由 2026-08-21 全栈启动验收时实测生成（`java-live.log` / `docker ps` / `/api/v3/api-docs` / `/openapi.json` / 前端 router 交叉核对）。
>
...
| 对外 API | OpenApiController | 1 | `/openapi/chat` |
