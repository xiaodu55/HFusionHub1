...
![Tests](https://img.shields.io/badge/Tests-Python%201409%20%7C%20Java%20693%20%7C%20Frontend%2049-success)
...
**Python AI 总计：1409 测试函数（2026-09-01 实测）| Java 后端：693 测试 | 前端：49 单测 + 73 E2E**
...
> （Java 693 测试 / Python 1409 / 前端 49 单测 + 73 E2E / Flyway V82 / DeepSeek 已配置）。
...
| [docs/java-backend.md](docs/java-backend.md) | Java 后端开发指南：项目结构、设计模式、环境变量、Flyway 规则（V1–V82）、测试与构建 |
...
| [docs/database.md](docs/database.md) | 数据库设计：V1–V82 全部迁移历史、核心表、实体关系、迁移规则 |
