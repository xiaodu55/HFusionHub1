...
public interface ModelUsageRecordMapper extends BaseMapper<ModelUsageRecord> {
     ...
     */
    List<DailyCostDTO> selectDailyCostByUser(@Param("userId") Long userId,
     ...
     */
    Map<String, Object> selectTotalCostByTenant(@Param("tenantId") Long tenantId,
                                                @Param("startDate") LocalDateTime startDate,
     ...
     * @return total_cost / total_tokens / total_requests
     */
    Map<String, Object> selectTotalCostByUser(@Param("userId") Long userId,
                                              @Param("startDate") LocalDateTime startDate,
                                              @Param("endDate") LocalDateTime endDate);
     ...
     */
    List<Map<String, Object>> selectCostBreakdown(@Param("tenantId") Long tenantId,
