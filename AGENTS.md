...
- **Tests**: Java 701 · Python 1431 · Frontend 49 (unit) + 73 (E2E). `scripts/static-checks.py --test-counts` enforces doc/code sync.
...
- **Schema changes**: create a new Flyway `V85+` script; never touch V1–V84. Always add `tenant_id` to new tables.
