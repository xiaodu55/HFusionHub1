...
const menuItems: Array<{
  ...
  { path: '/builder/models', sidebar: false, label: '我的模型', description: '选择供应商和模型', icon: Cpu, group: 'personal', keywords: ['model', '模型', 'llm', 'embedding', '向量'] },
  { path: '/builder/tools', sidebar: false, label: 'AI 能力', description: '查看和创建可用工具', icon: Wrench, group: 'personal', keywords: ['工具', 'tool', 'mcp', '能力'] },
  { path: '/agent', sidebar: false, label: '运行记录', description: '查看执行和失败原因', icon: Sparkles, group: 'personal', keywords: ['运行', '任务', 'agent', '失败'] },
  { path: '/approvals', sidebar: false, label: '待确认操作', description: '允许或阻止敏感操作', icon: Fingerprint, group: 'personal', keywords: ['确认', '审批', '允许', '拒绝'] },
  { path: '/memory', sidebar: false, label: '我的记忆', description: '管理 AI 记住的信息', icon: User, group: 'personal', keywords: ['记忆', 'memory'] },
  { path: '/notes', sidebar: false, label: '我的笔记', description: '查看 Agent 保存的笔记', icon: StickyNote, group: 'personal', keywords: ['笔记', 'note', '写笔记'] },
  { path: '/cost', sidebar: false, label: '模型用量', description: '查看调用次数和预估费用', icon: DollarSign, group: 'personal', keywords: ['用量', '费用', '成本', 'token'] },
  ...
  { path: '/builder/apps', sidebar: false, label: '应用发布', description: '打包知识库为对外 API', icon: Rocket, roles: ['builder', 'admin'], group: 'build', keywords: ['应用', '发布', 'api', 'key', 'app'] },
  { path: '/builder/mcp', sidebar: false, label: 'MCP 服务', description: '接入外部 MCP 工具服务器', icon: Cable, roles: ['builder', 'admin'], group: 'build', keywords: ['mcp', '外部', '服务', 'cable'] },
  { path: '/admin/flags', label: '能力开关', description: '直接开启或关闭 AI 增强能力', icon: ShieldCheck, roles: ['admin'], group: 'admin', keywords: ['开关', 'flag', '能力'] },
  { path: '/admin/intent-tree', sidebar: false, label: '问题分流', description: '让不同问题使用对应知识库', icon: GitBranch, roles: ['admin'], group: 'admin', keywords: ['意图', '路由', '问题分流', 'intent tree'] },
  { path: '/admin/users', label: '账号权限', description: '给新用户分配身份', icon: Users, roles: ['admin'], group: 'admin', keywords: ['用户', '权限', '身份', '角色'] },
  { path: '/admin/notices', sidebar: false, label: '公告管理', description: '发布和删除系统公告', icon: Megaphone, roles: ['admin'], group: 'admin', keywords: ['公告', '通知', 'notice', '发布'] },
  { path: '/admin/audit-logs', label: '审计日志', description: '敏感操作与跨租户审计', icon: ScrollText, roles: ['admin'], group: 'admin', keywords: ['审计', 'audit', '日志', '跨租户'] },
  { path: '/admin/plans', sidebar: false, label: '套餐管理', description: '维护平台套餐目录', icon: Package, roles: ['admin'], group: 'admin', keywords: ['套餐', '订阅', '目录', '方案包', 'plan'] },
]
